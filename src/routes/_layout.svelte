...
<main>
	...
	<ul className="social-links">
		...
		<li>
			<a href="https://twitter.com/garita_center" title="Twitter GaritaCenter" rel="nofollow">
				<svg width="50" height="50" viewBox="0 0 30 30">
					<circle cx="15" cy="15" r="15" fill="#666" />
	...
	<footer>
		<p><a href="garitas">GaritaCenter</a> muestra el <a href="reporte">reporte</a> de garitas para cruzar la linea de Tijuana a San Ysidro. Datos extraidos de la la U.S. CBP, para vehículos particulares o cruce peatonal.</p>
