...
<section>
	<div class="msg">
		Las Garitas están cerrada para viajes no esenciales hasta Febrero 21, 2021. <br />La prueba de Covid solo es necesaria por aire. <a href="./faq">Más información</a>
	</div>
	{#if report }
		{#each report as port}
